<template>
  <ul class="table-view" v-bind:class="{'card':card, 'table-noarrow':arrow==='false'}">
      <li v-for="it in list"
          ...
          v-bind:class="{'table-view-cell':!it.isDivider, 'table-view-divider':it.isDivider,  'table-view-collapse':it.collapse, 'table-view-full':(it.badge===void 0)}" transition="fade">
